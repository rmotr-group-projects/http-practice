...
def perform_post_request():
    """Perform POST request to given URL sending given json-data and return the response"""
...
def perform_put_request():
    """Perform PUT request to given URL sending given json-data and return the response"""
...
def perform_patch_request():
    """Perform PATCH request to given URL sending given json-data and return the response"""
